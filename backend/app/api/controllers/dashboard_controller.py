...
async def create_dashboard(user_id: int, service: dashboard_service):
    return await service.create_dashboard(user_id)


async def update_dashboard(dashboard_id: int, body: DashboardUpdateTheme, service: dashboard_service):
    return await service.update_dashboard(dashboard_id, body.dashboard_theme)


async def delete_dashboard(dashboard_id: int, service: dashboard_service):
